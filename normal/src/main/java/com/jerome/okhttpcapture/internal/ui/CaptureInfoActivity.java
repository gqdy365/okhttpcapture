...
import com.jerome.okhttpcapture.internal.utils.GetCaptureDataUtils;
...
public class CaptureInfoActivity extends AppCompatActivity implements GetCaptureDataUtils.CallBackSlide {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("APP内抓包工具");
        toolbar.setNavigationIcon(R.drawable.open_icon);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                InitCapture.get().getCacheUtils().cleanCache();
